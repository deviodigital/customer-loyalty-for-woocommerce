...
if ( ! class_exists( 'Customer_Loyalty_OSA' ) ) :
	...
	class Customer_Loyalty_OSA {
		...
		public function plugin_page() {
			echo '<div class="wrap">';
			echo '<h1>' . __( 'Customer Loyalty for WooCommerce', 'clwc' ) . ' <span style="font-size:50%;">v' . esc_attr( CUSTOMER_LOYALTY_VERSION ) . '</span></h1>';
				...
				<?php foreach ( $this->sections_array as $form ) { ?>
					...
					<div id="<?php echo $form['id']; ?>" class="group" >
						<form method="post" action="options.php">
							...
							do_action( 'clwc_form_bottom_' . $form['id'], $form );
							?>
